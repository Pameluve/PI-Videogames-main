...
import { getVideogames, createdByFilter, orderByName, orderByRating, filterByGenres, getGenres } from "../redux/actions";
...
//---------------------------HANDLERS-------------------------------
    ...
    return(
        <div className="backgroundHome">
            ...
            />
            <button id="buttonHome" onClick={(event)=> {clickHandler(event)}}>Cargar todos los juegos</button>
